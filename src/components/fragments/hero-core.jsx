...
export default function HeroCore() {
  return (
    <div className="grid grid-rows-1 gap-5 justify-items-center p-5 w-full mt:grid-cols-2 mt:max-w-mt md:max-w-3xl md:grid-cols-4 lg:max-w-6xl lg:grid-rows-1">
      ...
      <div className="rounded-2xl w-full h-max bg-secondary text-white p-4 flex justify-start lm:justify-center mt:h-full md:w-max lg:w-full lg:justify-start">
        <div className="w-max flex flex-col justify-center items-start gap-2 mt:gap-4 md:gap-2">
          <p className="font-light text-sm mt:text-base md:text-sm ">
            Hello World, my name is
          </p>
          <div className="font-bold text-4xl flex flex-row gap-2 mt:flex-col md:text-2xl lg:text-4xl">
            <p>Bayu</p>
            <p>Setiawan</p>
          </div>
          <p className="font-medium text-2xl md:text-lg">Fullstack Developer</p>
        </div>
      </div>
      <div className="w-full h-52 font-semibold text-2xl flex justify-center items-center mt:col-span-2 mt:max-w-md md:w-5/6 md:h-full lg:w-full lg:max-w-lg">
